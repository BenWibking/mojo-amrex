...
struct StagedArray4F32(Movable):
    ...
    def __init__[
        origin: Origin[mut=True]
    ](out self, ref ctx: DeviceContext, array: Array4F32View[origin]) raises:
    ...
    def load_from_host[
        origin: Origin[mut=True]
    ](mut self, ref ctx: DeviceContext, array: Array4F32View[origin]) raises:
...
struct StagedTileF32(Movable):
    ...
    def __init__[
        origin: Origin[mut=True]
    ](out self, ref ctx: DeviceContext, tile: TileF32View[origin]) raises:
    ...
    def store_to_host[
        origin: Origin[mut=True]
    ](mut self, ref ctx: DeviceContext, tile: TileF32View[origin]) raises:
